...
class $StudentPhonesTable extends StudentPhones
    with TableInfo<$StudentPhonesTable, StudentPhone> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $StudentPhonesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'student_phones';
  @override
  VerificationContext validateIntegrity(
    Insertable<StudentPhone> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  StudentPhone map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return StudentPhone(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
  ...
  @override
  $StudentPhonesTable createAlias(String alias) {
    return $StudentPhonesTable(attachedDatabase, alias);
  }
}

class StudentPhone extends DataClass implements Insertable<StudentPhone> {
  final String id;
  final String studentId;
  ...
  StudentPhonesCompanion toCompanion(bool nullToAbsent) {
    return StudentPhonesCompanion(
      id: Value(id),
      studentId: Value(studentId),
  ...
  StudentPhone copyWithCompanion(StudentPhonesCompanion data) {
    return StudentPhone(
      id: data.id.present ? data.id.value : this.id,
      studentId: data.studentId.present ? data.studentId.value : this.studentId,
  ...
  @override
  String toString() {
    return (StringBuffer('StudentPhone(')
          ..write('id: $id, ')
          ..write('studentId: $studentId, ')
  ...
  @override
  int get hashCode =>
      Object.hash(id, studentId, phoneNumber, label, createdAt, deviceId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is StudentPhone &&
          other.id == this.id &&
          other.studentId == this.studentId &&
...
class StudentPhonesCompanion extends UpdateCompanion<StudentPhone> {
  final Value<String> id;
  final Value<String> studentId;
  ...
  StudentPhonesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       phoneNumber = Value(phoneNumber),
       deviceId = Value(deviceId);
  static Insertable<StudentPhone> custom({
    Expression<String>? id,
    Expression<String>? studentId,
  ...
  StudentPhonesCompanion copyWith({
    Value<String>? id,
    Value<String>? studentId,
  ...
  @override
  String toString() {
    return (StringBuffer('StudentPhonesCompanion(')
          ..write('id: $id, ')
          ..write('studentId: $studentId, ')
          ..write('phoneNumber: $phoneNumber, ')
          ..write('label: $label, ')
...
class $TeacherPhonesTable extends TeacherPhones
    with TableInfo<$TeacherPhonesTable, TeacherPhone> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $TeacherPhonesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'teacher_phones';
  @override
  VerificationContext validateIntegrity(
    Insertable<TeacherPhone> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TeacherPhone map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TeacherPhone(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
  ...
  @override
  $TeacherPhonesTable createAlias(String alias) {
    return $TeacherPhonesTable(attachedDatabase, alias);
  }
}

class TeacherPhone extends DataClass implements Insertable<TeacherPhone> {
  final String id;
  final String teacherId;
  final String phoneNumber;
  final String? label;
  ...
  TeacherPhonesCompanion toCompanion(bool nullToAbsent) {
    return TeacherPhonesCompanion(
      id: Value(id),
      teacherId: Value(teacherId),
      phoneNumber: Value(phoneNumber),
      label: label == null && nullToAbsent
  ...
  TeacherPhone copyWithCompanion(TeacherPhonesCompanion data) {
    return TeacherPhone(
      id: data.id.present ? data.id.value : this.id,
      teacherId: data.teacherId.present ? data.teacherId.value : this.teacherId,
      phoneNumber: data.phoneNumber.present
  ...
  @override
  String toString() {
    return (StringBuffer('TeacherPhone(')
          ..write('id: $id, ')
          ..write('teacherId: $teacherId, ')
          ..write('phoneNumber: $phoneNumber, ')
          ..write('label: $label, ')
  ...
  @override
  int get hashCode =>
      Object.hash(id, teacherId, phoneNumber, label, createdAt, deviceId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TeacherPhone &&
          other.id == this.id &&
          other.teacherId == this.teacherId &&
          other.phoneNumber == this.phoneNumber &&
          other.label == this.label &&
...
class TeacherPhonesCompanion extends UpdateCompanion<TeacherPhone> {
  final Value<String> id;
  final Value<String> teacherId;
  final Value<String> phoneNumber;
  final Value<String?> label;
  ...
  TeacherPhonesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       phoneNumber = Value(phoneNumber),
       deviceId = Value(deviceId);
  static Insertable<TeacherPhone> custom({
    Expression<String>? id,
    Expression<String>? teacherId,
    Expression<String>? phoneNumber,
    Expression<String>? label,
  ...
  TeacherPhonesCompanion copyWith({
    Value<String>? id,
    Value<String>? teacherId,
    Value<String>? phoneNumber,
    Value<String?>? label,
  ...
  @override
  String toString() {
    return (StringBuffer('TeacherPhonesCompanion(')
          ..write('id: $id, ')
          ..write('teacherId: $teacherId, ')
          ..write('phoneNumber: $phoneNumber, ')
          ..write('label: $label, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $StudentPhonesTable studentPhones = $StudentPhonesTable(this);
  late final $TeacherPhonesTable teacherPhones = $TeacherPhonesTable(this);
  @override
...
final class $$StudentsTableReferences
  ...
  static MultiTypedResultKey<$StudentPhonesTable, List<StudentPhone>>
  _studentPhonesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.studentPhones,
    aliasName: 'students__id__student_phones__student_id',
  );

  $$StudentPhonesTableProcessedTableManager get studentPhonesRefs {
    final manager = $$StudentPhonesTableTableManager(
      $_db,
      $_db.studentPhones,
    ).filter((f) => f.studentId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(_studentPhonesRefsTable($_db));
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  }
...
class $$StudentsTableFilterComposer
  ...
  Expression<bool> studentPhonesRefs(
    Expression<bool> Function($$StudentPhonesTableFilterComposer f) f,
  ) {
    final $$StudentPhonesTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.studentPhones,
      getReferencedColumn: (t) => t.studentId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$StudentPhonesTableFilterComposer(
            $db: $db,
            $table: $db.studentPhones,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
...
class $$StudentsTableAnnotationComposer
  ...
  Expression<T> studentPhonesRefs<T extends Object>(
    Expression<T> Function($$StudentPhonesTableAnnotationComposer a) f,
  ) {
    final $$StudentPhonesTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.studentPhones,
      getReferencedColumn: (t) => t.studentId,
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$StudentPhonesTableAnnotationComposer(
            $db: $db,
            $table: $db.studentPhones,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
              ...
              ({
                ...
                return PrefetchHooks(
                  ...
                  explicitlyWatchedTables: [
                    ...
                    if (studentPhonesRefs) db.studentPhones,
                  ],
                  addJoins: null,
...
final class $$TeachersTableReferences
  ...
  static MultiTypedResultKey<$TeacherPhonesTable, List<TeacherPhone>>
  _teacherPhonesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.teacherPhones,
    aliasName: 'teachers__id__teacher_phones__teacher_id',
  );

  $$TeacherPhonesTableProcessedTableManager get teacherPhonesRefs {
    final manager = $$TeacherPhonesTableTableManager(
      $_db,
      $_db.teacherPhones,
    ).filter((f) => f.teacherId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(_teacherPhonesRefsTable($_db));
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  }
...
class $$TeachersTableFilterComposer
  ...
  Expression<bool> teacherPhonesRefs(
    Expression<bool> Function($$TeacherPhonesTableFilterComposer f) f,
  ) {
    final $$TeacherPhonesTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.teacherPhones,
      getReferencedColumn: (t) => t.teacherId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$TeacherPhonesTableFilterComposer(
            $db: $db,
            $table: $db.teacherPhones,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
...
class $$TeachersTableAnnotationComposer
  ...
  Expression<T> teacherPhonesRefs<T extends Object>(
    Expression<T> Function($$TeacherPhonesTableAnnotationComposer a) f,
  ) {
    final $$TeacherPhonesTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.teacherPhones,
      getReferencedColumn: (t) => t.teacherId,
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$TeacherPhonesTableAnnotationComposer(
            $db: $db,
            $table: $db.teacherPhones,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
              ...
              ({
                ...
                return PrefetchHooks(
                  ...
                  explicitlyWatchedTables: [
                    ...
                    if (teacherPhonesRefs) db.teacherPhones,
                  ],
                  addJoins: null,
                  getPrefetchedDataCallback: (items) async {
                    return [
...
typedef $$SpecialCasesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool studentId, bool approvedByUserId})
    >;
typedef $$StudentPhonesTableCreateCompanionBuilder =
    StudentPhonesCompanion Function({
      required String id,
      required String studentId,
      required String phoneNumber,
      Value<String?> label,
...
typedef $$StudentPhonesTableUpdateCompanionBuilder =
    StudentPhonesCompanion Function({
      Value<String> id,
      Value<String> studentId,
      Value<String> phoneNumber,
...
final class $$StudentPhonesTableReferences
    extends BaseReferences<_$AppDatabase, $StudentPhonesTable, StudentPhone> {
  $$StudentPhonesTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
  ...
  static $StudentsTable _studentIdTable(_$AppDatabase db) =>
      db.students.createAlias('student_phones__student_id__students__id');
...
class $$StudentPhonesTableFilterComposer
    extends Composer<_$AppDatabase, $StudentPhonesTable> {
  $$StudentPhonesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$StudentPhonesTableOrderingComposer
    extends Composer<_$AppDatabase, $StudentPhonesTable> {
  $$StudentPhonesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$StudentPhonesTableAnnotationComposer
    extends Composer<_$AppDatabase, $StudentPhonesTable> {
  $$StudentPhonesTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$StudentPhonesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $StudentPhonesTable,
          ...
          $$StudentPhonesTableOrderingComposer,
          $$StudentPhonesTableAnnotationComposer,
          $$StudentPhonesTableCreateCompanionBuilder,
          $$StudentPhonesTableUpdateCompanionBuilder,
          (StudentPhone, $$StudentPhonesTableReferences),
          StudentPhone,
          PrefetchHooks Function({bool studentId})
        > {
  $$StudentPhonesTableTableManager(_$AppDatabase db, $StudentPhonesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$StudentPhonesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$StudentPhonesTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$StudentPhonesTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
                Value<String> studentId = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$StudentPhonesTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback: ({studentId = false}) {
                    ...
                    if (studentId) {
                      state =
                          state.withJoin(
                                currentTable: table,
                                currentColumn: table.studentId,
                                referencedTable: $$StudentPhonesTableReferences
                                    ._studentIdTable(db),
                                referencedColumn: $$StudentPhonesTableReferences
                                    ._studentIdTable(db)
                                    .id,
                              )
                              as T;
...
typedef $$StudentPhonesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $StudentPhonesTable,
      StudentPhone,
      ...
      PrefetchHooks Function({bool studentId})
    >;
typedef $$TeacherPhonesTableCreateCompanionBuilder =
    TeacherPhonesCompanion Function({
      required String id,
      required String teacherId,
      required String phoneNumber,
      Value<String?> label,
...
typedef $$TeacherPhonesTableUpdateCompanionBuilder =
    TeacherPhonesCompanion Function({
      Value<String> id,
      Value<String> teacherId,
      Value<String> phoneNumber,
...
final class $$TeacherPhonesTableReferences
    extends BaseReferences<_$AppDatabase, $TeacherPhonesTable, TeacherPhone> {
  $$TeacherPhonesTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
  ...
  static $TeachersTable _teacherIdTable(_$AppDatabase db) =>
      db.teachers.createAlias('teacher_phones__teacher_id__teachers__id');
...
class $$TeacherPhonesTableFilterComposer
    extends Composer<_$AppDatabase, $TeacherPhonesTable> {
  $$TeacherPhonesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$TeacherPhonesTableOrderingComposer
    extends Composer<_$AppDatabase, $TeacherPhonesTable> {
  $$TeacherPhonesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$TeacherPhonesTableAnnotationComposer
    extends Composer<_$AppDatabase, $TeacherPhonesTable> {
  $$TeacherPhonesTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$TeacherPhonesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $TeacherPhonesTable,
          ...
          $$TeacherPhonesTableOrderingComposer,
          $$TeacherPhonesTableAnnotationComposer,
          $$TeacherPhonesTableCreateCompanionBuilder,
          $$TeacherPhonesTableUpdateCompanionBuilder,
          (TeacherPhone, $$TeacherPhonesTableReferences),
          TeacherPhone,
          PrefetchHooks Function({bool teacherId})
        > {
  $$TeacherPhonesTableTableManager(_$AppDatabase db, $TeacherPhonesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$TeacherPhonesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$TeacherPhonesTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$TeacherPhonesTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> id = const Value.absent(),
                Value<String> teacherId = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$TeacherPhonesTableReferences(db, table, e),
                ),
              )
              .toList(),
                    ...
                    if (teacherId) {
                      state =
                          state.withJoin(
                                currentTable: table,
                                currentColumn: table.teacherId,
                                referencedTable: $$TeacherPhonesTableReferences
                                    ._teacherIdTable(db),
                                referencedColumn: $$TeacherPhonesTableReferences
                                    ._teacherIdTable(db)
                                    .id,
                              )
                              as T;
...
typedef $$TeacherPhonesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $TeacherPhonesTable,
      TeacherPhone,
...
class $AppDatabaseManager {
  ...
  $$StudentPhonesTableTableManager get studentPhones =>
      $$StudentPhonesTableTableManager(_db, _db.studentPhones);
  $$TeacherPhonesTableTableManager get teacherPhones =>
      $$TeacherPhonesTableTableManager(_db, _db.teacherPhones);
}
