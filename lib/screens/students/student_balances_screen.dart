            ...
            child: Row(children: [
              ...
              Material(
                ...
                child: InkWell(
                  ...
                  onTap: () => _openBulkPayment(),
                  child: Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      const Icon(PhosphorIcons.currencyCircleDollar, size: 13, color: ShellTokens.accent),
                      const SizedBox(width: 4),
                      Text('Bulk Pay', style: TextStyle(fontSize: 10, color: ShellTokens.accent, fontWeight: FontWeight.w600)),
                    ]),
                  ),
                ),
              ),
    ...
    return TableRow(
      ...
      children: [
        ...
        GestureDetector(onTap: () => _openDetail(entry), behavior: HitTestBehavior.opaque,
          child: _textCell(entry['schoolLevel'] as String? ?? 'â€”')),
        GestureDetector(onTap: () => _openDetail(entry), behavior: HitTestBehavior.opaque,
...
class _BulkPaymentDialog extends StatefulWidget {
  final AppDatabase database;
  const _BulkPaymentDialog({required this.database});
  @override
...
class _BulkPaymentDialogState extends State<_BulkPaymentDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return ShellDialog(
      maxWidth: 500, maxHeight: 650, title: 'Bulk Payment',
      body: _loading
